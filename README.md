...
1. **Patient**
    ...
    - Fields may include:
        ...
        - `appointmentDTOS`: a list of `Appointment` objects linked to this patient

2. **Appointment**
    - Represents a scheduled appointmentDto or event for a patient.
    - Fields may include:
        - `id`: auto-generated primary key
        - `reason`: a textual reason for the appointmentDto (e.g., “Checkup”)
        - `date`: the date of the appointmentDto
        - `patient`: a reference to the `Patient` who owns this appointmentDto
